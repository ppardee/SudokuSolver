...
func PrintPuzzle(s *SudokuPuzzle) {
...
func SimpleSolve(s *SudokuPuzzle) int {
...
func ComplexSolve(s *SudokuPuzzle) int {
	startCount := s.UnknownCount
...
// NewSudokuPuzzle returns a guesses matrix based on the state of the puzzle
